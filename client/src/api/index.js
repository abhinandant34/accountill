...
export const fetchTransactionsWithSearch = (searchQuery) =>
  API.post(`/transactions/search`, searchQuery);

export const addTransaction = (transaction) =>
  API.post("/transactions", transaction);
export const uploadTransFile = (formData) =>
...
export const fetchTransactionsByUser = (searchQuery) =>
  API.get(`/transactions/user?searchQuery=${searchQuery.search}`);
